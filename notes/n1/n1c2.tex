...
Los textos en español se componen de palabras; los programas en Python se componen de \emph{valores}. Ejemplos de valores son números y secuencias de caracteres. Algunos valores:
\begin{minted}{python}
42
3.14
"Hola"
\end{minted}
El primer valor es el número entero 42, el segundo es el número decimal 3.14 y el tercero es una secuencia de cuatro caracteres del teclado: \mintinline{python}|H|, \mintinline{python}|o|, \mintinline{python}|l|, \mintinline{python}|a|.
...
\hline
\mintinline{python}|str| & \textit{string} & cadena de caracteres\footnote{La palabra \textit{string} generalmente traduce a hilo y en algunos contextos a cadena. Solo el contexto específico de la programación en español es convencional traducirla como cadena de caracteres.} & Secuencias de caracteres del teclado & \mintinline{python}|"Hol4"|, \mintinline{python}|'u78%6#a'| \\
\hline
\end{tabular}
