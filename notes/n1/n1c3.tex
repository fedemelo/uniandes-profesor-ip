...
\subsection{Funciones \textit{built-in}}

\subsubsection{Funciones de conversión de tipos}

% TODO: Y type

\subsubsection{Algunas funciones matemáticas}

% TODO: max, min, abs, pow, round

\subsubsection{Funciones de entrada y salida}
