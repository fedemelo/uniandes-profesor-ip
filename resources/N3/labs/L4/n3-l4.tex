...
Entregue el archivo \texttt{modulo.py} a través de Bloque Neón en el laboratorio del Nivel 3 designado como ``N3-L4: Lectura de archivos y recorrido de diccionarios''.
