...
% TODO: I'm using manual pagebreaks for now, due to time constraints, 
% because the docclass incorrectly cuts content at the end of the page.
\pagebreak
...
Cree un archivo comprimido .zip con el archivo \texttt{n2-l2.py}. Entregue el archivo comprimido a través de Bloque Neón en el laboratorio del Nivel 1 designado como ``L2: Funciones''.
\end{sectionbox}
