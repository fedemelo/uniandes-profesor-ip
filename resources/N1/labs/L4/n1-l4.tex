...
\begin{sectionbox}{Entrega}
  Cree un archivo comprimido .zip que contenga exactamente dos archivos .py: el módulo de la capa de lógica y el de la capa de presentación. Entregue el archivo comprimido a través de Bloque Neón en el laboratorio del Nivel 1 designado como ``L4: Pre parcial''.
\end{sectionbox}
